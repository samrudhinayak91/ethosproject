...
func (e *Encoder) myType(v *MyType) (err os.Error){
     ...
     if _, _, error := e.t.PointerCheck(unsafe.Pointer(v), "83b9883308f7f9c8a56b032a5546713de5285562e128e165115ce4d05ea7b288af9c18430ad6b808fa7cac9dc9c9d38acd7bc2ae1451ac6ed66b708d2b0e6e38", uint64(unsafe.Sizeof(*v))); error == nil {
     	
       err = e.float64(v.Field1)
       if err != nil {
       	  return err
       }
       
       err = e.float64(v.Field2)
       if err != nil {
       	  return err
       }
       
       err = e.float64(v.Field3)
       if err != nil {
       	  return err
       }
       
       err = e.float64(v.Field4)
       if err != nil {
       	  return err
       }
...
func (e *Encoder) any(a Any) (err os.Error){
     ...
     case MyType:
     	hashByte, err := hex.DecodeString("83b9883308f7f9c8a56b032a5546713de5285562e128e165115ce4d05ea7b288af9c18430ad6b808fa7cac9dc9c9d38acd7bc2ae1451ac6ed66b708d2b0e6e38")
	if err != nil {
	   return err
	}
     	// hashByte := []byte("83b9883308f7f9c8a56b032a5546713de5285562e128e165115ce4d05ea7b288af9c18430ad6b808fa7cac9dc9c9d38acd7bc2ae1451ac6ed66b708d2b0e6e38")
     	// e.string("83b9883308f7f9c8a56b032a5546713de5285562e128e165115ce4d05ea7b288af9c18430ad6b808fa7cac9dc9c9d38acd7bc2ae1451ac6ed66b708d2b0e6e38")
...
func (d *Decoder) any() (retValue *Any, error os.Error) {
     ...
     case bytes.Equal(encodedHash, []byte("83b9883308f7f9c8a56b032a5546713de5285562e128e165115ce4d05ea7b288af9c18430ad6b808fa7cac9dc9c9d38acd7bc2ae1451ac6ed66b708d2b0e6e38")):
...
func (t *MyType) CreateDirectory(fd syscall.Fd, name string, label string) (syscall.Status) {
       hash := goodmiddleman.HashValue{ 0x83,0xb9,0x88,0x33,0x08,0xf7,0xf9,0xc8,0xa5,0x6b,0x03,0x2a,0x55,0x46,0x71,0x3d,0xe5,0x28,0x55,0x62,0xe1,0x28,0xe1,0x65,0x11,0x5c,0xe4,0xd0,0x5e,0xa7,0xb2,0x88,0xaf,0x9c,0x18,0x43,0x0a,0xd6,0xb8,0x08,0xfa,0x7c,0xac,0x9d,0xc9,0xc9,0xd3,0x8a,0xcd,0x7b,0xc2,0xae,0x14,0x51,0xac,0x6e,0xd6,0x6b,0x70,0x8d,0x2b,0x0e,0x6e,0x38, }  
